...
List<FlutterCommand> generateCommands({
  ...
  final GlobalExtensionRegistry registry =
  ...
  return <FlutterCommand>[
    ...
    EmulatorsCommand(),
    ExtensionsCommand(extensionRegistry: registry, logger: globals.logger),
    GenerateCommand(),
    ...
    UpgradeCommand(verboseHelp: verboseHelp, extensionRegistry: registry),
